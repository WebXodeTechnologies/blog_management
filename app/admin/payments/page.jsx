  ...
  return (
    <div className="space-y-8 font-sans">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-3xl font-extrabold font-sans text-slate-950 tracking-tight flex items-center gap-2">
            <CreditCard className="w-6 h-6 text-emerald-600" />
            Revenue & Subscription Analytics
          </h2>
          <p className="text-xs text-slate-900 mt-3">
            Monitor Razorpay payment transactions, monthly recurring revenue
            (MRR), and SaaS subscription tiers.
          </p>
        </div>
