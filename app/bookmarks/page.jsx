...
export default function BookmarksPage() {
  const [savedArticles, setSavedArticles] = useState(STANDARDIZED_ARTICLES.slice(0, 4));
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {filteredBookmarks.length === 0 ? (
          <div className="p-16 rounded-3xl bg-white border border-dashed border-slate-200 text-center space-y-4 max-w-xl mx-auto my-8">
            ...
            <Link
              href="/explore"
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-slate-950 hover:bg-blue-600 text-white text-xs font-semibold shadow-sm transition"
            >
