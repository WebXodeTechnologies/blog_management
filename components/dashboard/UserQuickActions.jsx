...
import { PenTool, Bookmark, FileText, ArrowRight, Layers } from "lucide-react";
  ...
  const actions = [
    {
      ...
      description:
        "Create and publish deep technical guides with TipTap editor.",
    ...
    },
    {
      ...
      title: "My Articles",
      description:
        "Manage drafts, published posts, and track reader engagement.",
    ...
    },
    {
      ...
      description:
        "Access tutorials and architecture benchmarks saved for later.",
    ...
    },
    {
      ...
      description:
        "Discover trending tech topics across system design, Rust, AI, and Web3.",
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {actions.map((action, idx) => (
          <motion.div
            ...
            whileHover={{ y: -3 }}
            className={`rounded-3xl border shadow-2xs transition-all flex flex-col justify-between group overflow-hidden ${
              action.highlight
          ...
          >
            ...
            >
              ...
              <div
                className={`pt-4 mt-4 border-t ${action.highlight ? "border-white/20" : "border-slate-100"}`}
              >
                <div
