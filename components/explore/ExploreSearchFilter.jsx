...
export default function ExploreSearchFilter({
  ...
  return (
    <div className="flex items-center gap-2 overflow-x-auto pb-4 mb-6 border-b border-slate-200/60 scrollbar-none font-sans">
      {CATEGORY_NAMES.map((catName, idx) => {
        ...
        return (
          <button
            ...
            className={`text-xs font-sans px-4 py-2 rounded-full transition-all cursor-pointer shrink-0 ${
              isActive
